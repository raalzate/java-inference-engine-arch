...
/**
 * Main application that analyzes Java projects and generates architecture outputs:
 * 1. output.json - Complete dependency graph with all components and their metadata
 * 2. output_architecture.json - Clusters based on cohesion and coupling analysis
 */
public class MicroserviceInferenceMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            com.extractor.inference.ConsolidatedArchitecture architecture = 
                recommendationEngine.analyzeConsolidated(candidates, dependencyGraph.getComponents(), projectDeps);
